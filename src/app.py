...
class Producto(db.Model):   # la clase Producto hereda de db.Model    
    ...
    def __init__(self,nombre,apellido,edad,email):   #crea el  constructor de la clase
...
def create_producto():
    ...
    new_producto=Producto(nombre,apellido,edad,email)
...
def update_producto(id):
    ...
    producto.email=request.json['email']
